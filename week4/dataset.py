...
from week4.sar_preprocessing import preprocess_sar_patch
from preprocessing.preprocess_s2 import preprocess_patch as preprocess_s2_patch
...
class PairedBigEarthNetDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> Tuple[torch.Tensor, Optional[torch.Tensor], torch.Tensor, str]:
        ...
        if self.s2_available:
            ...
            ms_tensor = torch.as_tensor(ms_tensor, dtype=torch.float32)
